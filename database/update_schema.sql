-- SmartFleet Pro Database Schema Update
-- Add trip_reports and mechanic_service_records tables
...
-- Delete old roles
DELETE FROM roles WHERE name IN ('operations_manager', 'accountant');
